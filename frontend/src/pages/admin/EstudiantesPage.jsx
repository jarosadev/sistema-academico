...
const EstudiantesPage = () => {
  ...
  const handleCrearEstudiante = async (data) => {
    const loadingToast = notificationService.loading('Creando estudiante...');
    try {
  ...
  const handleEditarEstudiante = async (data) => {
    const loadingToast = notificationService.loading('Actualizando estudiante...');
    try {
  ...
  const handleCambiarEstado = async (estudiante, nuevoEstado) => {
    ...
    if (confirmed) {
      const loadingToast = notificationService.loading('Cambiando estado...');
      try {
